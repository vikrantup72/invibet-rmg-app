...
export const joinBet = async (body, token, userId) => {
  ...
  return api.post(`${endpoints.joinBet}?user_id=${userId}`, updatedBody, {
...
export const update_profile = async (body, token) => {
  return api.put(`${endpoints.editProfile}`, body, {
    headers: { Authorization: token },
  });
};

export const addDevice = async (body, token) => {
  return api.post(`${endpoints.addDevice}`, body, {
    headers: { Authorization: token },
  });
};
...
export const recharge_wallet = async (body, token) => {
  return api.post(`${endpoints.recharge_wallet}`, body, {
    headers: { Authorization: `${token}` },
  });
};
...
export const addToCart = async (body, token) => {
  return api.post(`${endpoints.addCart}`, body, {
    headers: { Authorization: token },
  });
};

export const checkout = async (body, token) => {
  return api.post(`${endpoints.checkout}`, body, {
    headers: { Authorization: token },
  });
};
...
export const getHealth = async (userId, date, token) => {
  return api.get(
    `profile/${userId}/health-data?activity_date=${date}`,
    {},
    { headers: { Authorization: `Bearer ${token}` } }
  );
};
...
export const buyBooster = async (body, token) => {
  return api.post(`${endpoints.purchase_booster}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};
...
export const genertate_aadharOtp = async (body, token) => {
  return api.post(`${endpoints.generateAadharOtp}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};

export const submitAadharOtp = async (body, token) => {
  return api.post(`${endpoints.submitAadharOtp}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};

export const verifyPAN = async (body, token) => {
  return api.post(`${endpoints.verifyPan}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};

export const verifyBank = async (body, token) => {
  return api.post(`${endpoints.verifyBank}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};

export const withdraw_winnings = async (body, token) => {
  return api.post(`${endpoints.withdraw_winnings}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};
...
export const getAll_bets = async (user_id, token) => {
  return api.get(
    `${endpoints.all_bets}?user_id=${user_id ?? ""}`,
    {},
    { headers: { Authorization: token, "Content-Type": "application/json" } }
  );
};
...
export const saveFcm = async (body, token) => {
  return api.post(`${endpoints.send_fcm}`, body, {
    headers: { Authorization: token, "Content-Type": "application/json" },
  });
};
...
export const updateAppVersion = async (body) => {
  return api.post(`${endpoints.appVersion}`, body, {
    headers: { "Content-Type": "application/json" },
  });
};
export const getSignatureToken = async (token) => {
  return api.get(
    `${endpoints.spike_signature}`,
    {},
    { headers: { Authorization: token, "Content-Type": "application/json" } }
  );
};
export const sendLogActivity = async (token, data) => {
