...
export function MyBets({
  navigation,
}: BottomTabScreenProps<LoggedInBettingTabsParamsList, "betting/myBets">) {
      ...
      <FlatList
        data={
          selectedTab == "Active"
            ...
            ? myBets?.upcoming_bets
            : myBets?.completed_bets
        }
        ...
        renderItem={({ item, index }) => (
          <ActiveBetsCards
            ...
            deduction={
              (parseInt(item?.put_points) * parseInt(item?.joined_users) * 15) /
              100
            }
            totalAmount={
