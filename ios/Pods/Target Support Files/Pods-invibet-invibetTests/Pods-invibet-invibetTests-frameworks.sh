...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MultiplatformBleAdapter/MultiplatformBleAdapter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNImageCropPicker/RNImageCropPicker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RNNotifee/RNNotifee.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/React-nativeconfig/React_nativeconfig.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-background-timer/react_native_background_timer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-ble-plx/react_native_ble_plx.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-bluetooth-status/react_native_bluetooth_status.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-cashfree-pg-sdk/react_native_cashfree_pg_sdk.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-spike-sdk/react_native_spike_sdk.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/SpikeSDK/SpikeSDK.framework"
